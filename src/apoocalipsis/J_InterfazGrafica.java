...
public class J_InterfazGrafica extends javax.swing.JFrame {
    ...
    private void B_JugarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B_JugarActionPerformed
        if (O_Retomar_Partida_Empezada.isSelected()) {
            ...
            J_Tablero ventanaTablero = new J_Tablero(); // La nueva ventana se llama ventanaCrearPartida
            
            J_NombrarSupervivientes ventanaNombrarSupervivientes = new J_NombrarSupervivientes();
            
            ventanaTablero.setVisible(true);                    // Hacemos visible la ventana nueva
            this.setVisible(false);                                 // Ocultamos la ventana en la que estamos
            String arrayNombres[] = new String [TAM];
            boolean repetidos = false;
            do {
                    if(JOptionPane.showConfirmDialog(this, ventanaNombrarSupervivientes, "Introduzca el nombre de los supervivientes",
                                      JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE) == JOptionPane.OK_OPTION) {
                    //Recogida de datos

                    String nombreSuperviviente1 = ventanaNombrarSupervivientes.getNombreSuperviviente1();
                    arrayNombres[0] = nombreSuperviviente1;

                    String nombreSuperviviente2 = ventanaNombrarSupervivientes.getNombreSuperviviente2();
                    arrayNombres[1] = nombreSuperviviente2;

                    String nombreSuperviviente3 = ventanaNombrarSupervivientes.getNombreSuperviviente3();
                    arrayNombres[2] = nombreSuperviviente3;

                    String nombreSuperviviente4 = ventanaNombrarSupervivientes.getNombreSuperviviente4();
                    arrayNombres[3] = nombreSuperviviente4;
                    ...
                    for(int i=0; i<TAM; i++) {
                        ...
                        if (repetidos) break; // Salir del primer bucle si ya se encontró un repetido
                    }
                }
